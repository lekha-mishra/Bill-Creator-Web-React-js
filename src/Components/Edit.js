...
function Edit() {
  ...
  const submit = (e1) => {
    ...
    axios
      .post("http://192.168.1.110:8000/api/bill/update", billInfo)
      .then((res) => {
              ...
              <tbody>
                {billInfo &&
                  billInfo.bill_description?.map((values, index) => {
                    ...
                    gsttotal = Boolean(billInfo ? billInfo?.has_gst : 0)
                      ? (
                          parseFloat(total) +
                    ...
                    discountVal = Boolean(
                      billInfo ? billInfo?.has_discounts : 0
                    )
                      ? (
                          parseFloat(gsttotal) -
                      ...
                      <tr key={index}>
                        ...
                        <td style={{ height: "10px" }}>
                          <Form.Control
                            ...
                            type="text"
                            style={{ color: "black" }}
                            className="form-control no-border border-0 bg-transparent"
                          />
                        </td>
                        <td>
                          <Form.Control
            ...
            >
              <Col md="auto">
                <Form.Group controlId="ApplyGST">
                  <Form.Check
                    checked={
                      Boolean(billInfo ? billInfo.has_gst : 0) || checked
                    }
                ...
                <div style={{ display: "flex", alignItems: "center" }}>
                  <Col md="auto">
                    <Form.Group controlId="ApplyDiscount">
                      <Form.Check
                        checked={Boolean(billInfo ? billInfo.has_discounts : 0)}
